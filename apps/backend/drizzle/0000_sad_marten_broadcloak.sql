...
CREATE TYPE "public"."widget_type" AS ENUM('text', 'quick-links', 'file-list', 'recent-activity', 'ai-widget');--> statement-breakpoint
...
CREATE TABLE "tags" (
	...
	"name" text NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "tags_organization_id_workspace_id_name_unique" UNIQUE("organization_id","workspace_id","name")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
